...
from GPJax_AScannell.gpjax.custom_types import Covariance, Input1, Input2, SingleInput
from jaxtyping import Array
from functools import partial


def covariance_decorator(
    kern_fn: Callable[[dict, SingleInput, Optional[SingleInput]], Array]
...
class Kernel(abc.ABC):
    ...
    @staticmethod
    def K_diag(params: dict, X: Input1):
