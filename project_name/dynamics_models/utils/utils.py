...
def rollout(env, discount_factor, agent=None, recording_path=None, evaluation=False):
    ...
    # recorder = VideoRecorder(env, base_path=recording_path, enabled=(recording_path is not None))  # TODO have removed this
    ...
    rollout_statistics = {"Return": rollout_return, "Discounted return": rollout_discounted_return}
